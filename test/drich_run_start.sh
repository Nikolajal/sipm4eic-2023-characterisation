...
### normal test-beam sequence
/au/pdu/measure/interprocess.sh $device 0x3f9 ### start of run
/au/pdu/measure/interprocess.sh $device 0x3fd ### start of spill
### trigger-pulse test sequence
#/au/pdu/measure/interprocess.sh $device 0x5f9 ### start of run
#/au/pdu/measure/interprocess.sh $device 0x5fd ### start of spill
