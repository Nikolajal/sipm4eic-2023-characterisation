...
//
typedef std::map<std::string, std::map<std::string, std::map<std::string, std::pair<double, double>>>> breakdown_voltages_type;
typedef std::map<std::string, std::map<std::string, std::map<std::string, std::map<std::string, std::pair<double, double>>>>> breakdown_voltages_sensors_type;
//
std::pair<double, double> find_vbd_guess(TGraphErrors *gLogTarget)
{
    auto vbd_guess = 0.;
...
template <int method = 6>
std::vector<TGraphErrors *>
measure_gain(std::vector<TGraphErrors *> iv_graphs, std::vector<TGraphErrors *> dcr_graphs, std::map<TString, std::pair<double, double>> breakdown_voltages)
{
    std::vector<TGraphErrors *> result;
    auto iTer = -1;
    for (auto current_iv : iv_graphs)
...
namespace database
{
    ...
    std::pair<double, double> get_breakdown_voltage(std::string board, std::string channel, std::string step)
    {
